...
public class WebcamRecon extends LinearOpMode {
    ...
    Driver_settings drivetrain = new Driver_settings();// Replace with the focal length of the camera in pixels
